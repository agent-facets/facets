...
<Update label="2026-07-13" description="Server-side search for facet search; asset names now follow the Agent Skills grammar" tags={["CLI", "Improvement", "Breaking"]} rss={{
