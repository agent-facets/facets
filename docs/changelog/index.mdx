...
<Update label="2026-07-09" description="TypeScript 7 is now a supported peer for @agent-facets/protocol, @agent-facets/adapter, @agent-facets/brand, and the first-party adapters" tags={["Improvement"]} rss={{
  title: "TypeScript 7 support for the public packages",
  description: "The public @agent-facets/* packages -- @agent-facets/protocol, @agent-facets/adapter, @agent-facets/brand, @agent-facets/adapter-claude-code, @agent-facets/adapter-codex, and @agent-facets/adapter-opencode -- now declare their typescript peerDependency as ^5 || ^6 || ^7, so they install cleanly on projects that have upgraded to TypeScript 7. Consumers on TypeScript 5 or 6 are unaffected."
}}>
