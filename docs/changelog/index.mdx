...
<Update label="2026-07-13" description="facet search now uses server-side filtering, sorting, and paging" tags={["CLI", "Improvement"]} rss={{
  title: "facet search now uses server-side filtering, sorting, and paging",
