...
<Update label="2026-09-02" description="Installing a facet from a git source no longer crashes on a cold cache" tags={["CLI", "Fix"]} rss={{
  ...
  [`facet install`](/cli/install) failed for you with this error, run it
  again.
</Update>
