...
<AccordionGroup>
  ...
  <Accordion title='"the registry returned an unusable target version" / "unusable latest version" during update'>
  ...
  <Accordion title='"adapter incompatible" / "unsupported adapter API" (build, add, remove, install, update fail before writing)' id='adapter-incompatible'>
