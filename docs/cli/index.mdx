...
<Columns cols={2}>
  ...
  <Card title={<Badge>facet modify</Badge>} href="/cli/authoring/modify">
    Headless, scriptable edits  -- add, remove, rename, re-describe assets, and set adapter config
  </Card>
  ...
  <Card title={<Badge>facet instructions</Badge>} href="/cli/instructions">
    Print CLI usage instructions for AI agents  -- the non-interactive, machine-readable workflows
  </Card>
