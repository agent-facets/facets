...
<ResponseField name="effective name" type="chosen by the project">
  The name the asset is materialized under: the file an [adapter](/specification/terminology#core-concepts) resolves and plans against. It equals the authored name unless the consuming project aliased it.
</ResponseField>
