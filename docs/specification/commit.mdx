...
<CardGroup cols={2}>
  <Card title="Desired state authorizes writes" icon="pen">
    Every desired effective identity is reconciled, even if an untracked file already occupies it. Reconciling it is what makes it tracked; the committed receipt records it from then on.
  </Card>
