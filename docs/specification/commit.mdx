...
- this machine's [install receipt](#machine-local-install-receipt) is readable and witnesses every survivor it records — same version, same materialized assets, same dispositions, same owned files.
