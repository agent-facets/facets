...
`README.md` and the extensionless `README` are ordinary top-level `files` declarations. There is no README-specific manifest field. Authoring support is described in [Create a Facet](/guides/create-your-first-facet) and [`facet edit`](/cli/authoring/edit).
