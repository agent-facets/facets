...
<ResponseField name="http" type="Streamable HTTP server">
  ...
  <Expandable title="http declaration">
    ...
    <ResponseField name="url" type="string" required>
      An absolute `http:` or `https:` URL. Relative URLs and other schemes (`file:`, `ws:`, `wss:`) are rejected, as are URLs carrying embedded credentials (`https://user:token@host/...`) — a declaration ships inside a published artifact and carries no secrets.
    </ResponseField>
  </Expandable>
</ResponseField>
