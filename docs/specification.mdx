...
This specification defines the authoritative requirements for the Facets format and protocol. For introductory material, see [Introduction](/) and [Key Concepts](/learn).
