...
describe('parseAdapterSpecifier', () => {
  ...
  test('git+https URL is parsed', () => {
    ...
    expect(result.resolved).toEqual({ type: 'git', url: 'https://github.com/user/repo.git' })
  })
  ...
  test('git+ssh URL is parsed', () => {
    ...
    expect(result.resolved).toEqual({ type: 'git', url: 'ssh://git@github.com/user/repo.git' })
  })
  ...
  test('relative path ./path resolves as local', () => {
    ...
    expect(result.resolved).toEqual({ type: 'local', path: './my-adapter' })
  })
  ...
  test('parent path ../path resolves as local', () => {
    ...
    expect(result.resolved).toEqual({ type: 'local', path: '../adapters/opencode' })
  })
  ...
  test('absolute path resolves as local', () => {
    ...
    expect(result.resolved).toEqual({ type: 'local', path: '/home/user/adapter' })
  })
})
