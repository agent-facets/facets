...
export type ResolveLocalResult = { ok: true; dir: string } | { ok: false; error: string }

export async function resolveLocalSource(path: string, projectRoot: string): Promise<ResolveLocalResult> {
