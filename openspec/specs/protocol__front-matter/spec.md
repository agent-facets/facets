...
Defines how YAML front matter is encoded in facet asset files (skills, agents, commands), how malformed front matter is tolerated, and how author-supplied attributes are merged with manifest-declared attributes at install time.
